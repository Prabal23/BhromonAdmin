    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(rents.equals("")){
                    Toast.makeText(AddVehicles.this, "Please fill up the rent section (অনুগ্রহকরে ভাড়া অঙ্গশটি পূরণ করুন)", Toast.LENGTH_LONG).show();
                }else{
                    ...
                    try{
                        ...
                        HttpPost httpPost = new HttpPost("http://bhromondata.banijyadarpan.com/rentacar/carinsert.php");
                        //httpPost.setEntity(new UrlEncodedFormEntity(nameValuePairs));
                        httpPost.setEntity(new UrlEncodedFormEntity(nameValuePairs, HTTP.UTF_8));
                        HttpResponse response = httpClient.execute(httpPost);
                        HttpEntity entity = response.getEntity();
                        is = entity.getContent();
                        String msg = "Vehicles Inserted Successfully";
