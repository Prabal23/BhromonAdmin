...
public class RoomType extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.room_type);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getBaseContext(), AddHotelRoom.class);
    ...
    private void showCar() {
        ...
        try {
            ...
            packnum.setText(size+" Types of room");
            packnumbd.setText(" ("+s+" ধরণের রুম)");
        ...
        ListAdapter adapter = new SimpleAdapter(
                RoomType.this, list, R.layout.hotel_list_item,
                new String[]{"id", "name"},
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(getBaseContext(), RoomTypeSettings.class);
